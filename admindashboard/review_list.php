            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            <?php $i = 1;
                            $result = $mysqli->query("SELECT * FROM reviews INNER JOIN house ON reviews.house_id = house.house_id INNER JOIN user ON reviews.reviewer_id = user.user_id");
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a onclick="return confirm('Are you sure you want to delete this review?');" href="delete_review.php?id=<?php echo $row['user_id'] ?>" title="remove"><i class="far fa-trash-alt icon-small"></i></a>
                                    </td>
